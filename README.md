...
| `getComponentName`     | function          | This function is called to determine the component name to be used in report based on the `import` declaration.<br>Default: `({ imported, local, moduleName, importType }) => imported || local`                                                                                                                                                                 |
